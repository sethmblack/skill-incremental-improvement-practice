...
> "Count something. Anybody can count something."
> — From "Better"
...
After a month: four improvements.
After a quarter: twelve improvements.
After a year: you've transformed, one small change at a time.
...
**Step 1: Accept constraints**
No new hires. That's the canvas. What can you do with what you have?
...
Currently: First response averages 8 hours
This week's goal: First response within 2 hours for all tickets
...
**The principle:**
You can't hire more staff. But you can be 10% faster this week, and another 10% faster next month, and in six months you've transformed the function without a single new hire.
